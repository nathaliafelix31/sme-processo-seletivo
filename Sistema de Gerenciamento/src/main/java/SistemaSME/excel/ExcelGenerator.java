...
public class ExcelGenerator {
    ...
    private void write() {
        ...
        for (ProcessoSeletivoCadastro record: processoSeletivoCadastroList) {
            ...
            createCell(row, columnCount++, record.getCpf(), style);
            createCell(row, columnCount++, record.getRg(), style);
            createCell(row, columnCount++, record.getDataNascimento(), style);
            createCell(row, columnCount++, record.getEmail(), style);
            createCell(row, columnCount++, record.getTelefone(), style);
            createCell(row, columnCount++, record.getEndereco(), style);
            createCell(row, columnCount++, record.getVaga(), style);
            createCell(row, columnCount++, record.getDisciplina(), style);
            createCell(row, columnCount++, record.getTempoServico(), style);
            createCell(row, columnCount++, record.getAperfeicoamentoProfissional(), style);
            createCell(row, columnCount++, record.getCargaHoraria(), style);
            createCell(row, columnCount++, record.getPosGraduacao(), style);
            createCell(row, columnCount++, record.getHabilitado(), style);
            createCell(row, columnCount++, record.getCursandoLicenciatura(), style);
            createCell(row, columnCount++, record.getCursandoBacharelado(), style);
            createCell(row, columnCount++, record.getCursoNivelMedio(), style);
            createCell(row, columnCount++, record.getEnsinoMedioCompleto(), style);
            createCell(row, columnCount++, record.getEnsinoMedioIncompleto(), style);
            createCell(row, columnCount++, record.getEscolaridadeMedioIncompleto(), style);
            createCell(row, columnCount++, record.getAnoConclusaoEscolaridadeMedioIncompleto(), style);
            createCell(row, columnCount++, record.getEnsinoFundamentalCompleto(), style);
            createCell(row, columnCount++, record.getEnsinoFundamentalIncompleto(), style);
            createCell(row, columnCount++, record.getEscolaridadeFundamentalIncompleto(), style);
            createCell(row, columnCount++, record.getAnoConclusaoEscolaridadeFundamentalIncompleto(), style);
            createCell(row, columnCount++, record.getOutro(), style);
