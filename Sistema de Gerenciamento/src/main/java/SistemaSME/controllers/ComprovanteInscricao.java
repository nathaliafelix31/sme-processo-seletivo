...
import SistemaSME.repositories.Comprovantes;
...
public class ComprovanteInscricao implements Comprovantes {
    ...
    public void gerarCorpo() {
        String disciplina = this.processoSeletivoCadastro.getDisciplina() != null ? this.processoSeletivoCadastro.getDisciplina() : " ";        Paragraph paragraphCandidato = new Paragraph();
        ...
        paragraphCandidato.add(
                new Chunk(
                        " Nome do Candidato: "+ this.processoSeletivoCadastro.getNome()
                                ...
                                +" Cargo: "+ this.processoSeletivoCadastro.getVaga() +" "+ disciplina
